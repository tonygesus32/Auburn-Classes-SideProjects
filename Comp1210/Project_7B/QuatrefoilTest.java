...
public class QuatrefoilTest {
   ...
   /** A test that test compareToTest1(). */
   @Test public void compareToTest1() {
      Quatrefoil ex1 = new Quatrefoil("Small Example", 3.5);
      Quatrefoil ex2 = new Quatrefoil("Small Example", 3.5);     
      Assert.assertTrue(ex1.compareTo(ex2) == 0);
      
   }
   /** A test that test compareToTest2(). */
   @Test public void compareToTest2() {
      Quatrefoil ex1 = new Quatrefoil("Small Example", 3.5);
      Quatrefoil ex2 = new Quatrefoil("Small Example", 0);
      Assert.assertTrue(ex1.compareTo(ex2) == 1);
     
   }
   /** A test that test compareToTest3(). */
   @Test public void compareToTest3() {
      Quatrefoil ex1 = new Quatrefoil("Small Example", 0); 
      Quatrefoil ex2 = new Quatrefoil("Small Example", 3.5);
      Assert.assertTrue(ex1.compareTo(ex2) == -1); 
   } 
}
