	...
	using namespace std;
		...
		*/
		...
		int Encounter::decideEncounter(Character& character) {
			int chance = rand() % 100 + 1; // random number from 1 to 100
		...
		int Encounter::choosePuzzleReward(Character& character) {
			int value = rand() % 9; // random number from 0 to 8
		...
		int Encounter::encounterProfessor(Character& character) {
			...
			int value = rand() % 4; // random number from 0 to 3
		...
		int Encounter::encounterGruntWork(Character& character) {
			...
			int value = rand() % 3; // random number from 0 to 2
		...
		int Encounter::encounterPapersToGrade(Character& character) {
			...
			int value = rand() % 5; // random number from 0 to 4
		...
		int Encounter::encounterText(Character& character) {
			...
			int value = rand() % 2; // random number from 0 to 1
		...
		*/
		...
		int Menu::optionsMenu() {
			...
			do {
				...
				case 3:
					...
					break;
				default:
					cout << "Your input was invalid. Please enter a valid input: ";
					repeat = true;
				}
			} while (repeat);
		...
		int Menu::quitToOptionsMenu() {
			...
			do {
				...
				if (input == "Yes" || input == "yes") {
					...
					cout << "Please enter a valid input (Yes or No): ";
				}
			} while (repeat);
		...
		int Menu::pickpocket() {
			...
			int value = rand() % 8; // random number from 0 to 7
